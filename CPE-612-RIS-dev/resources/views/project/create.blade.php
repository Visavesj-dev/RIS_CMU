...
<body>
    ...
    <div class="tab">
        <button class="tablinks" type="button"
            onclick="window.location.href = '{{ route('project.create') }}';">ข้อมูลทั่วไป</button>
    </div>
        ...
        <form action="{{ route('project.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="project_type"
                                    value="{{ old('project_type')}}" list="project_type" required>
                                <datalist id="project_type">
                                    @foreach ($ProjectTypes as $type)
                                    <option value="{{ $type->name }}"
                                        {{ old('project_type') == $type->name ? 'selected':'' }}>
                                    </option>
                                    @endforeach
                                </datalist>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="strategy_type"
                                    value="{{ old('strategy_type')}}" list="strategy_type" required>
                                <datalist id="strategy_type">
                                    @foreach ($StrategyTypes as $type)
                                    <option value="{{ $type->name }}"
                                        {{ old('strategy_type') == $type->name ? 'selected':'' }}>
                                    </option>
                                    @endforeach
                                </datalist>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cmu_mis_code"
                                    value="{{ old('cmu_mis_code')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fund_type" value="{{ old('fund_type')}}"
                                    list="fund_type" required>
                                <datalist id="fund_type">
                                    @foreach ($FundTypes as $type)
                                    <option value="{{ $type->name }}"
                                        {{ old('fund_type') == $type->name ? 'selected':'' }}>
                                    </option>
                                    @endforeach
                                </datalist>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fund_giver_name"
                                    value="{{ old('fund_giver_name')}}" list="fund_giver_name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="fund_giver_address"
                                    value="{{ old('fund_giver_address')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="receipt_list"
                                    value="{{ old('receipt_list')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input style="background-color: #cccccc" type="text" class="form-control"
                                    name="period_calculation" list="period_calculation" value="0" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="all_money_project" type="text" class="form-control" name="all_money_project"
                                    value="{{ old('all_money_project')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="percent_OHC" type="text" class="form-control" name="percent_OHC"
                                    value="{{ old('percent_OHC')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="project_status"
                                    value="{{ old('project_status')}}" list="project_status" required>
                                <datalist id="project_status">
                                    @foreach ($ProjectStatus as $type)
                                    <option value="{{ $type->name }}"
                                        {{ old('project_status') == $type->name ? 'selected':'' }}>
                                    </option>
                                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="head_project" id="head"
                                    onchange="myFunction()" value="{{ old('head_project')}}" list="head_project"
                                    required>
                                <datalist id="head_project">
                                    @foreach ($lecturers as $lecturer)
                                    <option value="{{ $lecturer->fullname }}"
                                        {{ old('head_project') == $lecturer->fullname ? 'selected':'' }}></option>
                                    @endforeach

                                </datalist>
                                <datalist id="head_project"></datalist>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="department_subject" id="department"
                                    value="{{ old('department_subject')}}" list="department_subject" required>
                                <datalist id="department_subject">
                                    @foreach ($departments as $department)
                                    <option value="{{ $department->name }}"
                                        {{ old('department_subject') == $department->id ? 'selected':'' }}>
                                        {{ $department->name }}
                                    </option>
                                    @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input style="background-color: #cccccc" type="text" class="form-control"
                                    name="researcher" list="researcher" value="0" v disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="OHC_types" name="OHC_type"
                                    value="{{ old('OHC_type')}}" list="OHC_type" required>
                                <datalist id="OHC_type">
                                    @foreach ($OHCtypes as $type)
                                    <option value="{{ $type->name }}"
                                        {{ old('OHC_type') == $type->name ? 'selected':'' }}>
                                    </option>
                                    @endforeach
                                </datalist>
                            </div>
                    ...
                    <script>
                        separate_OHC(); //call from projecJava.js
                    </script>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>มช</label>
                                <input id="cmu" type="text" class="form-control" name="cmu" value="{{old('cmu')}}"
                                    list="cmu" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="faculty" type="text" class="form-control" name="faculty"
                                    value="{{old('faculty')}}" list="faculty" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="departments" type="text" class="form-control" name="department"
                                    value="{{old('department')}}" list="department" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input style="background-color: #cccccc" type="date" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input style="background-color: #cccccc" type="date" class="form-control"
                                    name="end_time" list="end_time" disabled>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input type="text" id="result_project" name="result_project"
                                                        value="{{ old('result_project')}}" style="width: 350px "
            ...
            <div class="row">
                <div class="mb-6 col-md-6 offset-md-6">
                    <div class="d-flex flex-row-reverse">
                        <a href="{{ route('project.index') }}" class="btn btn-outline-danger mt-3 mb-4 ml-2">ยกเลิก</a>
