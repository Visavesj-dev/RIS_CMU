...
<div class="container-fluid bg-white rounded pb-2 mb-4">
    ...
    <!-- head -->
    <h1 class="pt-4">สร้าง MoU</h1>

    <!-- Start Form -->
    <form action="/mou" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div id="partner_list">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control col-md-4" name="partners[{{ $loop->index }}][country]" list="countries"
                        placeholder="ประเทศ" value="{{ $partner['country'] }}" required>
                    <div class="input-group-append">
                        <button type="button" class="btn btn-outline-danger" type="button" onclick="deletePartner(this)">ลบ</button>
                    </div>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3 ml-2">
                ...
                <input type="text" class="form-control" name="department_custom" list="departments" value="{{ old('department_custom') }}">
            </div>
        ...
        <div class="form-group">
            <div class="row mt-2">
                <div class="col">
                    ...
                    <input type="date" class="form-control" id="made_agreement_at" name="made_agreement_at" value="{{ old('made_agreement_at') }}" required>
                </div>
                <div class="col">
        ...
        <div class="row">
            <div class="mb-6 col-md-6 offset-md-6">
                <div class="d-flex flex-row-reverse">
                    <a href="{{ route('mou.index') }}" class="btn btn-outline-danger mt-3 mb-4 ml-2">ยกเลิก</a>
