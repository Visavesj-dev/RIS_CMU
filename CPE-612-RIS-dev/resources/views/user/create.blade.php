...
<div class="container-fluid bg-white rounded pb-2 mb-4">
    ...
    <!-- head -->
    <h1 class="pt-4">เพิ่มผู้ใช้งาน</h1>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="email" id="email" value="{{ old('email') }}" pattern=".+@.*cmu\.ac\.th" placeholder="prasin.o@cmu.ac.th" required>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-start">
                    <div class="form-check mr-4">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_research_read" name="has_research_read" {{ old("has_research_read") ? 'checked':'' }}>
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_research_write" name="has_research_write" {{ old("has_research_write") ? 'checked':'' }}>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-start">
                    <div class="form-check mr-4">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_service_read" name="has_service_read" {{ old("has_service_read") ? 'checked':'' }}>
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_service_write" name="has_service_write" {{ old("has_service_write") ? 'checked':'' }}>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-start">
                    <div class="form-check mr-4">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_meeting_read" name="has_meeting_read" {{ old("has_meeting_read") ? 'checked':'' }}>
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_meeting_write" name="has_meeting_write" {{ old("has_meeting_write") ? 'checked':'' }}>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-start">
                    <div class="form-check mr-4">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_foreign_read" name="has_foreign_read" {{ old("has_foreign_read") ? 'checked':'' }}>
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" id="has_foreign_write" name="has_foreign_write" {{ old("has_foreign_write") ? 'checked':'' }}>
        ...
        <div class="row">
            <div class="mb-6 col-md-6 offset-md-6">
                <div class="d-flex flex-row-reverse">
                    <a href="{{ route('user.index') }}" class="btn btn-outline-danger mt-3 mb-4 ml-2">ยกเลิก</a>
                    <button type="submit" class="btn btn-primary mt-3 mb-4">เพิ่ม</button>
                </div>
            </div>
        </div>
    </form>
