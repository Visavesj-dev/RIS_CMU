...
<div class="container-fluid bg-white rounded pb-2 mb-4">
    ...
    <!-- Start Form -->
    <form action="{{ route('host.update', $host) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="position" value="{{ $host->position }}" required>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="speciality" value="{{ $host->speciality }}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="mb-6 col-md-6 offset-md-6">
                <div class="d-flex flex-row-reverse">
                    <a href="{{ route('host.index', $host->visitor_id) }}" class="btn btn-outline-danger mt-3 mb-4 ml-2">ยกเลิก</a>
